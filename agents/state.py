...
class AgentState(TypedDict, total=False):
    ...
    Attributes:
        ...
        final_recommendation: Agent 4 final recommendation label.
        recommendation_reason: Agent 4 concise justification text.
        report_path: Local path to Agent 4 generated report file.
